...
import com.habz.cgv.API.Api;
import com.habz.cgv.API.Interface;
import com.habz.cgv.adapter.LinkMovie;
import com.habz.cgv.model.ModelMovie;
...
//        });
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent moveIntent = new Intent(MainActivity.this, Akun.class);
                startActivity(moveIntent);
            }
        });
